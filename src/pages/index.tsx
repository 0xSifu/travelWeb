      ...
      <NextSeo
        ...
        additionalMetaTags={[
          ...
          },
          {
            ...
            content: "Visit Sulut (Lutfi)",
          },
        ]}
      />
      <MainLayout>
        <MainHero />
        <div className="px-5 md:px-20 py-10" style={{backgroundColor: "#010312"}}>
          <h4 className="text-3xl font-semibold" style={{color: "#FFFFFF"}}>Destinasi Pilihan</h4>
        ...
        <div className="container mx-auto text-center w-full lg:w-2/5">
            <h4 className="text-3xl font-semibold" style={{color:"#FFFFFF"}}>
              Hotel Pilihan
            </h4>
